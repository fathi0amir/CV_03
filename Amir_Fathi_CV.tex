...
\usepackage[left=1.5cm,right=2.3cm,top=2.3cm,bottom=2cm]{geometry}
\recomputelengths
...
\section{Technical Skills}
	...
	\cvlistdoubleitem{\small \raggedright Design, simulation and fabrication
					 ...
					 {\small \raggedright Certified in handling and operating SEM}
%------------------------------------------
%  Languages
%------------------------------------------
\section{Languages}
\cvitemwithcomment{Persian}{Native}{\hspace{-0.8em}\dotfill Farsi}
