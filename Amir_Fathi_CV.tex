...
\usepackage[left=1.5cm,right=3cm,top=3cm,bottom=2cm]{geometry}
\recomputelengths
...
\section{Technical Skills}
	\subsection{Computer}
	\cvlistdoubleitem{\small \raggedright Programming in MATLAB, LabVIEW,\newline 
					\footnotesize{familiar with R, python, C\# and C++ }}
					{\small \raggedright Typesetting with \TeX\:  \& \LaTeX Engine}
	\cvlistdoubleitem{\small \raggedright Image Processing in ImageJ, MATLAB}
	...
	\cvlistdoubleitem{\small \raggedright Calibration and maintanance of multi-zone
					...
					UV-Vis measurements}
	\cvlistdoubleitem{\small \raggedright Construction of femtosecond and nanosecond 
					transient absorption spectroscopy systems and related measurements}
					{\small \raggedright Construction of femtosecond pump-probe microscopy and related 
					image processing}
	\cvlistdoubleitem{\small \raggedright Design, simulation and fabrication
					 of electronic filters}
					 {\small \raggedright Programming scientific data acquisition systems 
					 with photo-diode, PMT, APD, EMCCD and iCCD as a detector}
%------------------------------------------
%  Languages
%------------------------------------------
\section{Languages}
...
\cvitemwithcomment{Spanish}{Intermediate . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .}{Español}
